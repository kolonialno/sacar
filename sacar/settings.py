...
VERSIONS_DIRECTORY: pathlib.Path = config("SACAR_VERSIONS_DIRECTORY", cast=pathlib.Path)
VERSIONS_HASH_LENGTH = config("SACAR_VERSIONS_HASH_LENGTH", cast=int, default=10)
